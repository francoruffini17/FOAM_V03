...
# ── ALLSD / ALLWK  stabilization energy / external work  (zoomed −1 % to +5 %) ─
A61b = frame_variable()
A61b.x_key_path = "['t']"
A61b.y_key_paths = []
...
# ── Canvas layout  (1800 × 1500, 4 cols × 3 rows, 400 × 400 per cell) ─────────
#   Col x:  50  470  890  1310
#   Row y:  80  530  980

T = frames_combination()
T.canvas_size = (1800, 1500)
...
T.vid_folder = 'Video_1004'
T.elements = [
    # ── Row 0: global curves + mesh animation ─────────────────────────────
    {
        "position": (50, 80),
        "size": (400, 400),
        "path": "frames_A1/",
    ...
    # ── Row 1: mesh quality / deformation metrics ──────────────────────────
    {
        "position": (50, 530),
        "size": (400, 400),
        "path": "frames_Q_eta/",
    ...
    # ── Row 2: energy density variability ─────────────────────────────────
    {
        "position": (50, 980),
        "size": (400, 400),
        "path": "frames_Q_wcv/",
