...
# Same as Video_properties_1010, but without the 4th column (eta_C^A, eta_C^R):
# reaction force, foam animation (S11+S22), tension/compression graphs,
# average global efficiency, tension/compression efficiency ratio, EDI mean,
# shear mean. Same panel naming/conventions as 1009/1010; every curve/scalar
# panel marks the localization point (frame index of the minimum of TP2_L's
# shear_mean).
...
#
#   Canvas: 1800 × 1580 (column 2 is tallest: IT/IC3002, FI3002, FFI3002)
#
