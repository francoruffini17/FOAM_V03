...
#
# x: displacement from DEFC2 pkl, negated (→ positive compression axis),
#    offset to Step-1 start via plot_from_0=True (subtracts D[0]).
# y: etaC_A and etaC_R (numpy arrays directly in DEFC2).

DEFC_etaCA = frame_variable()
DEFC_etaCA.x_key_path = "['displacement']"
DEFC_etaCA.y_key_paths = ["['etaC_A']"]
DEFC_etaCA.normalize_x = -1
DEFC_etaCA.legends = [r'$\eta_C^A$']
DEFC_etaCA.normalized_by = 1
DEFC_etaCA.invert_y = False
DEFC_etaCA.xlabel = "Step-1 compression [mm]"
DEFC_etaCA.ylabel = r'$\eta_C^A$'
DEFC_etaCA.title = None
DEFC_etaCA.derivative = False
DEFC_etaCA.save_path = 'frames_DEFC_etaCA/'
DEFC_etaCA.figsize = (4.75, 4)
DEFC_etaCA.dpi = 100
DEFC_etaCA.num_frames = num_frames
DEFC_etaCA.plot_from_0 = True
DEFC_etaCA.file_key_x = 'DEFC2'
DEFC_etaCA.file_key_y = 'DEFC2'
DEFC_etaCA.yscale = 'linear'

DEFC_etaCR = frame_variable()
DEFC_etaCR.x_key_path = "['displacement']"
DEFC_etaCR.y_key_paths = ["['etaC_R']"]
DEFC_etaCR.normalize_x = -1
DEFC_etaCR.legends = [r'$\eta_C^R$']
DEFC_etaCR.normalized_by = 1
DEFC_etaCR.invert_y = False
DEFC_etaCR.xlabel = "Step-1 compression [mm]"
DEFC_etaCR.ylabel = r'$\eta_C^R$'
DEFC_etaCR.title = None
DEFC_etaCR.derivative = False
DEFC_etaCR.save_path = 'frames_DEFC_etaCR/'
DEFC_etaCR.figsize = (4.75, 4)
DEFC_etaCR.dpi = 100
DEFC_etaCR.num_frames = num_frames
DEFC_etaCR.plot_from_0 = True
DEFC_etaCR.file_key_x = 'DEFC2'
DEFC_etaCR.file_key_y = 'DEFC2'
DEFC_etaCR.yscale = 'linear'
...
#   Column 4 (x=1800): DEFC_etaCA, DEFC_etaCR          — DEFC2 localization
#
#   Canvas: 2400 × 2600

T = frames_combination()
T.canvas_size = (2400, 2600)
...
T.elements = [
    ...
    # ── Column 4: DEFC2 localization indices ─────────────────────────────────
    {
        "position": (1800, 100),
        "size": (500, 500),
