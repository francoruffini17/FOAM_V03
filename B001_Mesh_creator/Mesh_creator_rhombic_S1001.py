...
This script:
  1. Creates  C001_Mesh_files/RH1001.mesh.json
  2. Creates  C001_Mesh_files/RH1001_I3002.gridhex.json  (hex overlay, hexagon_size=1/60)
...
mesh_path = "C001_Mesh_files/RH1001.mesh.json"
...
print(f"\nRH1001: {mesh.n_nodes} nodes | {mesh.n_elements} elements -> {mesh_path}")


# -----------------------------------------------------------------------
# 2.  Gridhex overlay for I-series reduction (I3002)
# -----------------------------------------------------------------------
gridhex_path = "C001_Mesh_files/RH1001_I3002.gridhex.json"
