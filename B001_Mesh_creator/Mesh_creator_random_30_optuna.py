...
try:
    ...
    raise SystemExit(
        ...
        "  python3 B001_Mesh_creator/Mesh_creator_random_30_optuna.py"
    ) from exc
...
N_TRIALS_PER_BATCH = 40
MAX_TRIALS_PER_TARGET = 100
INITIAL_REFERENCE_MESH_SIZES = [ 0.0018]
INITIAL_REFERENCE_NODE_COUNTS = [174867]
MIN_MESH_SIZES = [0.0015]
MAX_MESH_SIZES = [0.0018]
OUTPUT_TEMPLATE = "C001_Mesh_files/R030_{target_k:03d}k.mesh.json"
...
def build_mesh(mesh_size, filepath=None, export_mesh=False):
    _, mesh = create_random_mesh(
        config=cfg,
        filepath=filepath or "Temp/optuna_R030/not_exported.mesh.json",
