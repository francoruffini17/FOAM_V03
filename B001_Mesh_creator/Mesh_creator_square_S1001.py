...
This script:
  1. Creates  C001_Mesh_files/S1001.mesh.json
  2. Creates  C001_Mesh_files/S1001_I3002.gridhex.json  (hex overlay, hexagon_size=1/60)
...
mesh_path = "C001_Mesh_files/S1001.mesh.json"
...
generator, mesh = create_square_mesh(
    ...
    allow_cut_left=True,
    allow_cut_right=True,
    allow_cut_bottom=True,
    allow_cut_top=True,
    element_type="BOTH",
    mesh_size=0.0028,
    periodic="both",
...
print(f"\nS1001: {mesh.n_nodes} nodes | {mesh.n_elements} elements -> {mesh_path}")


# -----------------------------------------------------------------------
# 2.  Gridhex overlay for I-series reduction (I3002)
# -----------------------------------------------------------------------
gridhex_path = "C001_Mesh_files/S1001_I3002.gridhex.json"
