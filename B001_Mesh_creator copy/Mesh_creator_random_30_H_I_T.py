...
for val in vals:
    mesh_path = f"C001_Mesh_files/R030_{val:03d}k.mesh.json"
    for i in range(5):
        # create_grid_file(
        #     mesh_path,
        #     f"C001_Mesh_files/R030_{val:03d}k_H300{i+1}.grid.json",
        ...
        # create_gridhex_file(
        #     mesh_path,
        #     f"C001_Mesh_files/R030_{val:03d}k_I300{i+1}.gridhex.json",
        ...
        #     file_name=f"C001_Mesh_files/R030_{val:03d}k_T00{i+1}.tri",
        # )

        quadrangulation_generator(
            n_nodes_per_edge=int(floor(10*(1.3**i))),
            file_name=f"C001_Mesh_files/R030_{val:03d}k_Q00{i+1}.quad",
        )

        # plot_triangulation(
        #     f"C001_Mesh_files/R030_{val:03d}k_T00{i+1}.tri",
